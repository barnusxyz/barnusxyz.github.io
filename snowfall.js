var snowStorm = function(g, f) {
  ...
  this.resizeHandler = function() {
      g.innerWidth || g.innerHeight ? (h = g.innerWidth - 16 - a.flakeRightOffset,
      l = a.flakeBottom || g.innerHeight) : (h = (f.documentElement.clientWidth || f.body.clientWidth || f.body.scrollWidth) - (!m ? 8 : 0) - a.flakeRightOffset,
  ...
  this.toggleSnow = function() {
      a.flakes.length ? (a.active = !a.active,
      a.active ? (a.show(),
      a.resume()) : (a.stop(),
      a.freeze())) : a.start()
  }
  ...
  this.stop = function() {
      ...
      a.events.remove(f, "focusin", a.resume)) : (a.events.remove(g, "blur", a.freeze),
  ...
  this.SnowFlake = function(c, d, e) {
      ...
      ;
      this.stick = function() {
          r || a.targetElement !== f.documentElement && a.targetElement !== f.body ? b.o.style.top = l + p - a.flakeHeight + "px" : a.flakeBottom ? b.o.style.top = a.flakeBottom + "px" : (b.o.style.display = "none",
          b.o.style.top = "auto",
          b.o.style.bottom = "0%",
      ...
      this.move = function() {
          ...
          b.refresh();
          l + p - b.y + a.flakeHeight < a.flakeHeight ? (b.active = 0,
          a.snowStick ? b.stick() : b.recycle()) : (a.useMeltEffect && (b.active && 3 > b.type && !b.melting && 0.998 < Math.random()) && (b.melting = !0,
          b.melt()),
          a.useTwinkleEffect && (0 > b.twinkleFrame ? 0.97 < Math.random() && (b.twinkleFrame = parseInt(8 * Math.random(), 10)) : (b.twinkleFrame--,
  ...
  this.snow = function() {
      ...
      for (e = a.flakes.length; d < e; d++)
          1 === a.flakes[d].active && (a.flakes[d].move(),
          c++),
  ...
  this.start = function(c) {
      if (B) {
          ...
          B = !0;
      if ("string" === typeof a.targetElement && (c = a.targetElement,
      ...
      a.targetElement !== f.documentElement && a.targetElement !== f.body && (a.resizeHandler = a.resizeHandlerAlt,
